package org.cime.common.hash;

public class Crc16 {
	private static final int SLOT_SIZE = 16384;

	private static final int[] crc16tab = { 0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5, 0x60c6, 0x70e7, 0x8108,
	...
	private static int hash(String key) {
		...
		for (int x = 0; x < key.length(); x++) {
			crc = (crc << 8) ^ crc16tab[((crc >> 8) ^ key.charAt(x)) & 0x00ff];
		}
